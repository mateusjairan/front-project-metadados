...
function VideoTranscriptionApp() {
  ...
  const { currentTime, isPlaying, videoRef, handleTimeUpdate, handlePlay, handlePause, seekToTime } = useVideoSync()
  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>Upload a video and get synchronized transcription</p>
      </header>
